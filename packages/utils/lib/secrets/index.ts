...
export enum SecretsKeys {
  ...
  // Finix payment processing. Each clinic entity is a separate Finix
  // Application with its own API key (HTTP Basic username:password), Merchant,
  // and Merchant Identity. Only the API base URL/version are shared.
  FINIX_API_BASE_URL = 'FINIX_API_BASE_URL',
  FINIX_API_VERSION = 'FINIX_API_VERSION',
  FINIX_API_USERNAME_AFTEROURS = 'FINIX_API_USERNAME_AFTEROURS',
  FINIX_API_PASSWORD_AFTEROURS = 'FINIX_API_PASSWORD_AFTEROURS',
  FINIX_APPLICATION_ID_AFTEROURS = 'FINIX_APPLICATION_ID_AFTEROURS',
  FINIX_MERCHANT_ID_AFTEROURS = 'FINIX_MERCHANT_ID_AFTEROURS',
  FINIX_MERCHANT_IDENTITY_ID_AFTEROURS = 'FINIX_MERCHANT_IDENTITY_ID_AFTEROURS',
  FINIX_API_USERNAME_SPIRE = 'FINIX_API_USERNAME_SPIRE',
  FINIX_API_PASSWORD_SPIRE = 'FINIX_API_PASSWORD_SPIRE',
  FINIX_APPLICATION_ID_SPIRE = 'FINIX_APPLICATION_ID_SPIRE',
  FINIX_MERCHANT_ID_SPIRE = 'FINIX_MERCHANT_ID_SPIRE',
  FINIX_MERCHANT_IDENTITY_ID_SPIRE = 'FINIX_MERCHANT_IDENTITY_ID_SPIRE',
}
