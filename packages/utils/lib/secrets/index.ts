...
export enum SecretsKeys {
  ...
  RH_API_USERNAME = 'RH_API_USERNAME',
  RH_API_PASSWORD = 'RH_API_PASSWORD',
  RH_BASE_URL = 'RH_BASE_URL',
  RH_CIPHERPAY_BASE_URL = 'RH_CIPHERPAY_BASE_URL',
  RH_MERCHANT_GROUP_CODE = 'RH_MERCHANT_GROUP_CODE',
  RH_MAC_AFTEROURS = 'RH_MAC_AFTEROURS',
  RH_MAC_SPIRE = 'RH_MAC_SPIRE',
  RH_CIPHERPAY_API_KEY_AFTEROURS = 'RH_CIPHERPAY_API_KEY_AFTEROURS',
  RH_CIPHERPAY_API_KEY_SPIRE = 'RH_CIPHERPAY_API_KEY_SPIRE',
}
